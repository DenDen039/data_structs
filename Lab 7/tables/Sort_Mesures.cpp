    ...
    try
    {
      ...
      << endl;
        for (int i = from; i < to; i += step)
        {
            ...
            sort_check(arr,i,MergeSort1,f2);
            sort_check(arr,i,MergeSort2,f2);
      ...
      << endl;
        for (int i = from; i < to; i += step)
        {
            ...
            sort_check(arr,i,MergeSort1,f3);
            sort_check(arr,i,MergeSort2,f3);
      ...
      << endl;
        for (int i = from; i < to; i += step)
        {
            ...
            sort_check(arr,i,MergeSort1,f4);
            sort_check(arr,i,MergeSort2,f4);
